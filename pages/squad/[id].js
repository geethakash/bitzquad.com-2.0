      ...
      <div className="relative  flex flex-col-reverse overflow-hidden xl:h-screen xl:flex-row xl:overflow-y-scroll">
        <div className="flex h-full flex-col object-cover pr-0 xl:flex-auto xl:justify-between xl:pr-20 xl:pl-20 2xl:pl-40">
          ...
          >
            ...
            <h2 className="text-lg font-extralight text-gray-700 xl:mt-1 xl:text-2xl 2xl:mt-2 3xl:text-4xl">
              {member.role.text}
            </h2>
            <p className=" mt-3 text-base font-medium text-gray-700 xl:mt-5  xl:text-xl 2xl:mt-10 3xl:text-4xl">
              {member.description}
            </p>
          </motion.div>
          <motion.div
