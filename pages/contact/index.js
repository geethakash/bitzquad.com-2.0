    ...
    <>
      <LayoutSubPages>
        ...
        <div data-scroll-section>
          <img
            src="/assets/img/contact/bg-sm.svg"
            className="absolute left-0 right-0 block w-full -translate-y-28 md:hidden"
          />
                  ...
                  <div className="flex h-full flex-col justify-center gap-y-4 pl-8 text-base">
                    ...
                    >
                      ...
                      <a
                        ...
                        rel="noreferrer"
                      >
                        275/2 Katuwana Road, Homagama,<br></br> Colombo, Sri
                        Lanka 10200
                      </a>
                    </motion.div>
                  </div>
                    ...
                    <div className="mt-3 text-center sm:mt-5">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          One of our team member will contact you within 24
                          hours.
                        </p>
                      </div>
                    </div>
                ...
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6">
                  <div>
                    ...
                    <div className="mt-3 text-center sm:mt-5">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          Make sure you have a proper internet connection and
                          try again.
                        </p>
                      </div>
                    </div>
