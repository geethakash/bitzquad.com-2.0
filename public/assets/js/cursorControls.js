        ...
        var _config = {
          ...
          _getProperty = function _getProperty(target, property) {
            ...
            return _isFunction(currentValue)
              ? target[property]()
              : (_isUndefined(currentValue) && target.getAttribute(property)) ||
                  currentValue;
          },
...
*/
          ...
          _parsePosition = function _parsePosition(animation, position) {
            ...
            if (
              ...
              return i > 1
                ? _parsePosition(animation, position.substr(0, i - 1)) + offset
          ...
          _roundModifier = function _roundModifier(v) {
            ...
            return function (raw) {
              return (
                Math.floor(Math.round(parseFloat(raw) / v) * v * p) / p +
        ...
        var Timeline = /*#__PURE__*/ (function (_Animation) {
          ...
          function Timeline(vars, time) {
            ...
            _this.parent &&
              _postAddChecks(_this.parent, _assertThisInitialized(_this));
            vars.scrollTrigger &&
              ...
              tween = Tween.to(
                ...
                _setDefaults(vars, {
                  ...
                  onStart: function onStart() {
                    ...
                    tween._dur !== duration &&
                      _setDuration(tween, duration).render(
                        tween._time,
                        true,
                        true
                      );
        ...
        var Tween = /*#__PURE__*/ (function (_Animation2) {
          ...
          function Tween(targets, vars, time, skipInherit) {
            ...
            var _this3$vars = _this3.vars,
              ...
              parsedTargets = (
                _isArray(targets) ? _isNumber(targets[0]) : "length" in vars
              )
                ? [targets]
                : toArray(targets),
              tl,
          ...
          _proto3.kill = function kill(targets, vars) {
            ...
            if (this.timeline) {
              ...
              )._first || _interrupt(this); // if nothing is left tweenng, interrupt.

              this.parent &&
                tDur !== this.timeline.totalDuration() &&
                _setDuration(this, (this._dur * this.timeline._tDur) / tDur); // if a nested tween is killed that changes the duration, it should affect this tween's duration. We must use the ratio, though, because sometimes the internal timeline is stretched like for keyframes where they don't all add up to whatever the parent tween's duration was set to.
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
         ...
         */ var Cursor = /*#__PURE__*/ (function () {
          function Cursor(options) {
            ...
            this.body = jquery__WEBPACK_IMPORTED_MODULE_0___default()(
              this.options.container
            );
            this.el = jquery__WEBPACK_IMPORTED_MODULE_0___default()(
              '<div class="cursor-follower"></div>'
            );
            this.text = jquery__WEBPACK_IMPORTED_MODULE_0___default()(
              '<div class="cursor-follower-text"></div>'
            );
            this.init();
          }
          _createClass(Cursor, [
  ...
  \*************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var magnetic__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(/*! magnetic */ "./src/js/magnetic.js");
